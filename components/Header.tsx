...
const Header: React.FC<HeaderProps> = ({ activePage, user, onLogout, onNavigate, onMobileMenuToggle }) => {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 ${colors.sidebar} border-b-2 border-white/20 h-20 no-print shadow-lg`}
    >
      <div className="flex items-center justify-between px-4 sm:px-6 py-4 h-full">
        ...
        <div className="flex items-center space-x-1 sm:space-x-2 lg:space-x-4">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              <span className="text-white font-semibold hidden md:block text-sm lg:text-base truncate max-w-24 lg:max-w-none">
